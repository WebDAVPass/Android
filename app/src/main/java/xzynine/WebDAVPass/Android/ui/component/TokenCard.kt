...
private val iconResCache =
    object : LinkedHashMap<IconResCacheKey, Int?>(16, 0.75f, true) {
        override fun removeEldestEntry(eldest: MutableMap.MutableEntry<IconResCacheKey, Int?>) = size > ICON_RES_CACHE_MAX_SIZE
    }
...
fun EntryIcon(
     ...
     */
    val tokenImageRes: Int? =
        remember(standardIconId, primary, secondary) {
