...
class UnsignedInt(
     ...
     * Get the int value
     */
    fun toKotlinInt(): Int = unsignedValue

    /**
     * Convert an unsigned Integer to Long
     */
    fun toKotlinLong(): Long = unsignedValue.toLong() and INT_TO_LONG_MASK

    /**
     * Convert an unsigned Integer to Byte
     */
    fun toKotlinByte(): Byte = (unsignedValue and 0xFF).toByte()

    fun isBefore(value: UnsignedInt): Boolean = toKotlinLong() < value.toKotlinLong()

    override fun toString(): String = toKotlinLong().toString()
    ...
    override fun hashCode(): Int = unsignedValue
