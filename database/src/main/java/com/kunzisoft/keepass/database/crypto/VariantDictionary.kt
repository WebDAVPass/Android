...
open class VariantDictionary {
    ...
    fun getUInt32(name: String): UnsignedInt? = dict[name]?.value as UnsignedInt?
    ...
    fun getUInt64(name: String): UnsignedLong? = dict[name]?.value as UnsignedLong?
    ...
    fun getBool(name: String): Boolean? = dict[name]?.value as Boolean?
    ...
    fun getInt32(name: String): Int? = dict[name]?.value as Int?
    ...
    fun getInt64(name: String): Long? = dict[name]?.value as Long?
    ...
    fun getString(name: String): String? = getValue(name) as String?
    ...
    fun getByteArray(name: String): ByteArray? = getValue(name) as ByteArray?
