...
class TemplateBuilder {
    ...
    private val usernameAttribute =
        TemplateAttribute(
            label = TemplateField.LABEL_USERNAME,
            type = TemplateAttributeType.TEXT,
        )
    private val notesAttribute =
        TemplateAttribute(
    ...
    private val holderAttribute =
        TemplateAttribute(
            label = TemplateField.LABEL_HOLDER,
            type = TemplateAttributeType.TEXT,
        )
    private val numberAttribute =
        TemplateAttribute(
            label = TemplateField.LABEL_NUMBER,
            type = TemplateAttributeType.TEXT,
        )
    private val cvvAttribute =
        TemplateAttribute(
            label = TemplateField.LABEL_CVV,
            type = TemplateAttributeType.TEXT,
            protected = true,
        )
    private val pinAttribute =
        TemplateAttribute(
            label = TemplateField.LABEL_PIN,
            type = TemplateAttributeType.TEXT,
            protected = true,
        )
    private val nameAttribute =
        TemplateAttribute(
            label = TemplateField.LABEL_NAME,
            type = TemplateAttributeType.TEXT,
        )
    private val placeOfIssueAttribute =
        TemplateAttribute(
            label = TemplateField.LABEL_PLACE_OF_ISSUE,
            type = TemplateAttributeType.TEXT,
        )
    private val dateOfIssueAttribute =
        TemplateAttribute(
    ...
    private val expirationDateAttribute =
        TemplateAttribute(
    ...
    private val emailAddressAttribute =
        TemplateAttribute(
            label = TemplateField.LABEL_USERNAME,
            type = TemplateAttributeType.TEXT,
            options =
    ...
    private val passwordAttribute =
        TemplateAttribute(
            label = TemplateField.LABEL_PASSWORD,
            type = TemplateAttributeType.TEXT,
            protected = true,
        )
    private val ssidAttribute =
        TemplateAttribute(
            label = TemplateField.LABEL_SSID,
            type = TemplateAttributeType.TEXT,
        )
    private val wirelessTypeAttribute =
        TemplateAttribute(
